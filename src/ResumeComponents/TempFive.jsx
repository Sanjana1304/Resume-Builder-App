...
const TempFive = () => {
  ...
  return (
    <div className="resume-container">
      ...
      <div className="row p-3 temp5 ">
        <h1 className="col-12 fw-bold text-violet-2">{name}</h1>
        
        <h6 className="col-12 fw-bold text-violet py-1 mb-1">{title}</h6>

        <div className="col-5 border-violet ">
          <div className="row">

          <div className="col-12">
                <p className='p-text-2 fw-bold mb-1 mt-3 text-violet'>OBJECTIVE</p>
                <p className="p-text-2">{abt}</p>
          </div>

          <div className="col-12">
              <p className='p-text-2 fw-bold mb-1 mt-2  text-violet'>SKILLS</p>
              {
            ...
            <p className='p-text-2 fw-bold mb-1  text-violet'>CONTACT</p>
            ...
            <div className="col-12">
                  <p className='p-text-2 fw-bold mb-2 mt-2  text-violet'>CERTIFICATIONS</p>
                  <p className="p-text-2 mt-1 mb-2">{cert1} | {certGiven1}</p>
                  {cert2?<p className="p-text-2 mt-1 mb-2">{cert2} | {certGiven2}</p>:''}
                  {cert3?<p className="p-text-2 mt-1 mb-2">{cert3} | {certGiven3}</p>:''}
            </div>
        ...
        <div className="col-7">
              <div className="row">
                ...
                <div className="col-12">
                  <p className='p-text-2 fw-bold side-line mb-2 mt-3  text-violet'>EXPERIENCE</p>
                ...
                <div className="col-12">
                <p className='p-text-2 fw-bold mb-1 mt-2 side-line text-violet'>EDUCATION</p>
                ...
                <div className="col-12">
                  <p className='p-text-2 fw-bold side-line mb-2 mt-3  text-violet'>PROJECTS</p>
