  ...
  return (
    <div className="resume-container">
      <div className="row p-3 temp2 ">
        <h1 className="col-12 fw-bold text-black">{name}</h1>
        
        <h6 className="col-12 text-black fw-bold  py-1 mb-1">{title.toUpperCase()}</h6>

        <div className="col-5">
          <div className="row">

          <div className="col-12">
                <p className='p-text-2 fw-bold overline mb-1 mt-3'>OBJECTIVE</p>
                <p className="p-text-2">{abt}</p>
          </div>

            <div className="col-12">
            <p className='p-text-2 fw-bold overline mb-1'>CONTACT</p>
            ...
            <div className="col-12">
              <p className='p-text-2 fw-bold overline mb-1 mt-3'>SKILLS</p>
              {
            ...
            <div className="col-12">
              <p className='p-text-2 fw-bold overline mb-1 mt-3'>EDUCATION</p>
        ...
        <div className="col-7">
              <div className="row">
                ...
                <div className="col-12">
                  <p className='p-text-2 fw-bold overline mb-2 mt-3'>EXPERIENCE</p>
                ...
                <div className="col-12">
                  <p className='p-text-2 fw-bold overline mb-2 mt-3'>CERTIFICATIONS</p>
                ...
                <div className="col-12">
                  <p className='p-text-2 fw-bold overline mb-2 mt-3'>PROJECTS</p>
